...
export const executeDemoDataMigration = async () => {
  ...
  try {
    ...
    // Material Request data should be synced from backend, not seeded
    // Removed mock Material Request seeding - data should come from backend API
    console.log("📦 Skipping Material Request seeding - should be synced from backend API");
