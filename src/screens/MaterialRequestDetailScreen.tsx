...
import { pickingSessionService } from "../services/picking-session.service";
...
export default function MaterialRequestDetailScreen() {
  ...
  const handleViewStock = async (itemCode: string) => {
    ...
    try {
      ...
      console.log(`📦 Detected format: ${isGroupedFormat ? "Grouped (bin_location + cartons)" : "Legacy (location_id + qty)"}`);
      ...
      if (isGroupedFormat) {
        ...
        formattedStock = stockEntries
          ...
          .map((entry) => {
            ...
            // ✅ Enhanced logging to debug bin_location value
            console.log(
                        ...
                        <View style={styles.stockListLocationContainer}>
                          ...
                          {hasCartons && (
                            <View style={styles.cartonsList}>
                              {item.cartons.map((carton, idx) => (
                                <View key={idx} style={styles.cartonRow}>
